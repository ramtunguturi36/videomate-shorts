...
const LoginForm: React.FC<LoginFormProps> = ({ onToggleMode, isAdmin = false }) => {
    ...
    <div className="card p-8 w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2">
          {isAdmin ? 'Sign in to your admin account' : 'Sign in to your account'}
        </p>
      </div>
        ...
        >
          {loading ? (
            ...
            <>
              ...
              <span>{isAdmin ? 'Admin Login' : 'Sign In'}</span>
            </>
          )}
        </button>
      </form>
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-600">
          {isAdmin ? "Don't have an admin account?" : "Don't have an account?"}{' '}
          <button
            onClick={onToggleMode}
            className="text-primary-600 hover:text-primary-700 font-medium"
          >
            {isAdmin ? 'Contact Administrator' : 'Sign up'}
          </button>
        </p>
      </div>
